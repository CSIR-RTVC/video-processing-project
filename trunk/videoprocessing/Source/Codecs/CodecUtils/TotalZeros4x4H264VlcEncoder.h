...
FILE NAME			: TotalZeros4x4H264VlcEncoder.h
...
===========================================================================
*/
#ifndef _TOTALZEROS4X4H264VLCENCODER_H
#define _TOTALZEROS4X4H264VLCENCODER_H
...
---------------------------------------------------------------------------
*/
class TotalZeros4x4H264VlcEncoder : public IVlcEncoder
{
public:
	TotalZeros4x4H264VlcEncoder(void);
	virtual ~TotalZeros4x4H264VlcEncoder(void);
...
protected:
	...
	static const TZ4H264VE_VlcCodeType table[16][16];

};// end class TotalZeros4x4H264VlcEncoder.

#endif	// end _TOTALZEROS4X4H264VLCENCODER_H.
