...
FILE NAME			: MotionEstimatorH264ImplMultiresCross.h
...
===========================================================================
*/
#ifndef _MOTIONESTIMATORH264IMPLMULTIRESCROSS_H
#define _MOTIONESTIMATORH264IMPLMULTIRESCROSS_H
...
---------------------------------------------------------------------------
*/
typedef struct _MEH264IMC_COORD
{
	short int x;
	short int y;
} MEH264IMC_COORD;
...
---------------------------------------------------------------------------
*/
class MotionEstimatorH264ImplMultiresCross : public IMotionEstimator
{
/// Construction.
public:

	MotionEstimatorH264ImplMultiresCross(	const void* pSrc, 
																		const void* pRef, 
																		int					imgWidth, 
																		int					imgHeight,
																		int					motionRange);
	...
	virtual ~MotionEstimatorH264ImplMultiresCross(void);
...
};//end MotionEstimatorH264ImplMultiresCross.


#endif // !_MOTIONESTIMATORH264IMPLMULTIRESCROSS_H
