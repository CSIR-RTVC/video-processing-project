...
FILE NAME			: TotalZeros2x4H264VlcDecoder.h
...
===========================================================================
*/
#ifndef _TOTALZEROS2X4H264VLCDECODER_H
#define _TOTALZEROS2X4H264VLCDECODER_H
...
---------------------------------------------------------------------------
*/
class TotalZeros2x4H264VlcDecoder : public IVlcDecoder
{
public:
	TotalZeros2x4H264VlcDecoder();
	virtual ~TotalZeros2x4H264VlcDecoder();
...
};// end class TotalZeros2x4H264VlcDecoder.

#endif	// _TOTALZEROS2X4H264VLCDECODER_H
