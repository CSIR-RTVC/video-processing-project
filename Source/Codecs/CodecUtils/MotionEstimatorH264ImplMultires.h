...
FILE NAME			: MotionEstimatorH264ImplMultires.h
...
===========================================================================
*/
#ifndef _MOTIONESTIMATORH264IMPLMULTIRES_H
...
---------------------------------------------------------------------------
*/
typedef struct _MEH264IM_COORD
{
	short int x;
	short int y;
} MEH264IM_COORD;
...
---------------------------------------------------------------------------
*/
class MotionEstimatorH264ImplMultires : public IMotionEstimator
{
/// Construction.
public:
...
#endif // !_MOTIONESTIMATORH264IMPLMULTIRES_H
