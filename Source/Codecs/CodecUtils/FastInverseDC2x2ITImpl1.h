...
FILE NAME			: FastInverseDC2x2ITImpl1.h
...
=========================================================================================
*/
#ifndef _FASTINVERSEDC2X2ITIMPL1_H
#define _FASTINVERSEDC2X2ITIMPL1_H
...
---------------------------------------------------------------------------
*/
class FastInverseDC2x2ITImpl1 : public IInverseTransform
{
	public:
		FastInverseDC2x2ITImpl1(void);
		virtual ~FastInverseDC2x2ITImpl1()	{ }
	...
	protected:
		...
		int _weightScale[4];
		int _levelScale[6][4];	///< Pre-calc for each QP % 6.

		/// Hold these members that will only change when q changes.
		int	_q;						///< Current quantisation parameter.
		int	_qm;					///< _q % 6.
		int _qe;					///< _q / 6.
		int _leftScale;		///< Scaling left shift = _qe;
		int _rightScale;	///< Scaling right shift = 5;

};// end class FastInverseDC2x2ITImpl1.

#endif	//_FASTINVERSEDC2X2ITIMPL1_H
